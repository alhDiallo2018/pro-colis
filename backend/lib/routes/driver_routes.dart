...
class DriverRoutes {
  ...
  Router get router {
    ...
    // Récupérer les colis du chauffeur
    ...
    // Confirmer ramassage
    router.put('/parcels/<parcelId>/pickup', (Request request, String parcelId) async {
      final authCheck = await _authMiddleware(request);
      if (authCheck != null) return authCheck;
    ...
    // Confirmer livraison
    router.put('/parcels/<parcelId>/deliver', (Request request, String parcelId) async {
      final authCheck = await _authMiddleware(request);
      if (authCheck != null) return authCheck;
